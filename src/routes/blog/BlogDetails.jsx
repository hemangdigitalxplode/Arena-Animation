        ...
        <Row className="mt-n5">
          ...
          <Col sm={6} md={4} className="mt-5 wow fadeInUp" data-wow-delay=".4s" style={{ visibility: "visible",animationDelay: "0.4s",animationName: "fadeInUp",}}>
            <div className="blog-grid">
              ...
              <Link to="/blog/choosing-animation-delhi-ncr-for-your-3d-animation-course"> <img alt="img" src={animation3D}/>
              </Link> 
              </div>
              <div className="blog-grid-text p-4">
                <h3 className="h5 mb-3">
                  <Link to="/blog/choosing-animation-delhi-ncr-for-your-3d-animation-course">3D Animation Course in Noida</Link>
                </h3>
                ...
                <div className="meta meta-style2">
                  <ul>
                    <li>
                    <Link To="/blog/choosing-animation-delhi-ncr-for-your-3d-animation-course"><i className="fas fa-calendar-alt"></i> {"24 Jul, 2024"}</Link>
                    </li>
